...
// @section lcd
  ...
  #define MANUAL_FEEDRATE_XYZ 3000.0
  #define MANUAL_FEEDRATE { MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, MANUAL_FEEDRATE_XYZ, 60.0 } // Feedrates for manual moves along X, Y, Z, E from panel
